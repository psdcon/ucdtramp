...
function cluster(newText) {
    ...
    function getTypeData(object) {
        ...
        function Shellac(object, canvasID) { //split up the string into words
            ...
            context.translate(canvas.width / 2, 0); //font styling
            context.fillStyle = color;
            context.textBaseline = "middle";
            context.textAlign = "center";
            context.font = weight + " " + style + " " + size + " " + font; //cycle through each word, and create a phrase 
        ...
        Shellac(object, 'cluster_canvas'); //get stuff
